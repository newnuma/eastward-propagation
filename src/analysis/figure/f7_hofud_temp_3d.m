...
data = {Temp.d50.a, Temp.d50.x, Temp.d50.a - Temp.d50.x};
data_nan = {Temp.d100.xn, Temp.d100.xn, Temp.d100.xn};
data_axis = {[-2 2], [-1.5 1.5], [-2 2]};
data_title = {'(a)', '(b)', '(c)'};

% savename = "f7_hofud_temp_100.png";
% data = {Temp.d100.a, Temp.d100.x, Temp.d100.a - Temp.d100.x};
% data_nan = {Temp.d100.xn, Temp.d100.xn, Temp.d100.xn};
% data_axis = {[-1.5 1.5], [-1.5 1.5], [-1.5 1.5]};
% data_title = {'(d)', '(e)', '(f)'};
% 
% savename = "f7_hofud_temp_300.png";
% data = {Temp.d300.a, Temp.d300.x, Temp.d300.a - Temp.d300.x};
% data_nan = {Temp.d100.xn, Temp.d100.xn, Temp.d100.xn};
% data_axis = {[-0.5 0.5], [-0.5 0.5], [-0.5 0.5]};
% data_title = {'(g)', '(h)', '(i)'};
