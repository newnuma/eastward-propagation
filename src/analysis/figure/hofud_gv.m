...
for i=5:8:136 
    for j=1:91
     ...
     geov267_4m(i,j,k)=squeeze(mean(geoV263(i-4:i+4,j,k-4:k+4),[1 3])); %%%
...
for i=5:8:136 
    for j=1:91
     ...
     geov267_4m(i,j,k)=squeeze(mean(geoV267(i-4:i+4,j,k-4:k+4),[1 3])); %%%
