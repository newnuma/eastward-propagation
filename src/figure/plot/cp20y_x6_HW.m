...
%%変更部分%%
X1=Tmdy*12; %%対象データ(141×91×20)
value_range1=[-5 5]; %%データ値範囲

X2=asfay*12; %%対象データ(141×91×20)
value_range2=[-5 5]; %%データ値範囲

X3=entrain_way2*12; %%対象データ(141×91×20)
value_range3=[-5 5]; %%データ値範囲

X4=Dtx_mlday*12; %%対象データ(141×91×20)
value_range4=[-5 5]; %%データ値範囲

X5=Dty_mlday*12; %%対象データ(141×91×20)
value_range5=[-5 5]; %%データ値範囲
