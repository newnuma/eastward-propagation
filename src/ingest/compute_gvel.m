...
%COMPUTE_GVEL Compute geostrophic velocity from dynamic height.
%
%   compute_gvel(cfg)
%
%   Computes:
...
%   Saves base_data/gvel.mat with fields .u and .v
    ...
    grid    = load_grid(cfg);
    dheight = load_var(cfg, fullfile(cfg.paths.base_data, 'dheight.mat'), 'dheight');
    ...
    save_var(cfg, fullfile(cfg.paths.base_data, 'gvel.mat'), 'gvel', gvel);
    update_manifest(cfg, 'base_data', 'gvel', {'dheight'});
