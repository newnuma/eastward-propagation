function [fig, ax] = plot_timeseries(time, series, opts)
%PLOT_TIMESERIES  Multi-line time series plot with optional moving average.
%
%   [fig, ax] = plot_timeseries(time, series, opts)
%
